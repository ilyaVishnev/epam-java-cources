...
public class VampireNumberFactoryImpl implements VampireNumberFactory {
    ...
    public VampireNumber newInstance(int multiplication, int first, int second) {
        VampireNumberImpl vampireNumber = new VampireNumberImpl();
        vampireNumber.setFirst(first);
        vampireNumber.setSecond(second);
        vampireNumber.setMultiplication(multiplication);
